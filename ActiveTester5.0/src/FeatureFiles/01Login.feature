...
<<<<<<< HEAD
	Then	"STEP:LOGIN-05-02"	Verify login error: the user ID or the password is invalid remote changes demo local original
=======
	Then	"STEP:LOGIN-05-02"	Verify login error: the user ID or the password is invalid local changes for demo
>>>>>>> 186445d7e700b5e3ea790ee7a607e23601a8ab83
